  ...
  return (
    <div className="relative">
      ...
      > 
        ...
        {showFullSlide ?  
        (<Fade direction="left"> <div className="flex flex-col items-center justify-center mx-3 pt-10">
        ...
        </div></Fade>) : (<div className="flex flex-col mb-36 items-start">
          <h1 className="text-white font-semibold text-4xl pl-[13%]">DELVE</h1>
          <h1 className="text-white font-semibold text-4xl pl-[21%]">INTO</h1>
        </div>)}
      </div>
    </div>
  );
