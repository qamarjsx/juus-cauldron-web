...
function Slide({ name, text, mediaLink, shopRoute }) {
  ...
  return (
    <section
      ...
      style={{
        background:
          `linear-gradient(180deg, ${name === "Juus"? "rgba(102, 0, 0, 1)" : "rgba(17,19,130,1)"} 0%, rgba(0, 0, 0, 1) 39%)`,
      }}
    >
      <div>
      ...
      <Link to={shopRoute}>
        <button
          ...
          className="cursor-pointer my-10 flex items-center italic justify-between p-3 w-36 h-11 text-snow text-sm border rounded-full hover:bg-snow hover:text-rich-black hover:shadow-btn-shadow hover:shadow-snow transition"
        >
          Discover more
          <svg
